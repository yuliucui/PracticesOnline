...
public class DetectWebService extends Service {
    ...
    public class DateWebBinder extends Binder {
        ...
        public void detect() {
            AppUtils.getExecotor().execute(() -> {
                ...
                if (flag == FLAG_SERVER_EXCEPTION) {
                    ...
                    notifyUser("远程服务器右更新", android.R.drawable.ic_popup_sync, true);
        ...
        private void notifyUser(String info, int icon, boolean refresh) {
            ...
            PendingIntent pendingIntent=PendingIntent.getActivity(DetectWebService.
